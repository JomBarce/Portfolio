...
void main() {
    ...
    vec3 newPosition = position + normal * displacement * uDisplacement;

    // Rotaion X
    float rotationAngle = uTime * -uRotationSpeed;
    mat3 forwardRotationMatrix = rotateX(rotationAngle);
    newPosition = forwardRotationMatrix * newPosition;
